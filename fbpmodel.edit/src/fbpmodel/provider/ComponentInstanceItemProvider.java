...
/**
 * This is the item provider adapter for a {@link fbpmodel.ComponentInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentInstanceItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FbpmodelPackage.Literals.COMPONENT_INSTANCE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FbpmodelPackage.Literals.COMPONENT_INSTANCE__VARS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComponentInstance.class)) {
			case FbpmodelPackage.COMPONENT_INSTANCE__VARS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FbpmodelPackage.Literals.COMPONENT_INSTANCE__VARS,
				 FbpmodelFactory.eINSTANCE.createVariableValue()));
	}
