...
/**
 * This is the item provider adapter for a {@link fbpmodel.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_multiple_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_multiple_feature", "_UI_Port_type"),
				 FbpmodelPackage.Literals.PORT__MULTIPLE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Port.class)) {
			case FbpmodelPackage.PORT__MULTIPLE:
