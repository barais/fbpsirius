...
/**
 * This is the item provider adapter for a {@link fbpmodel.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FbpmodelPackage.Literals.CONFIGURATION__INSTANCE);
			childrenFeatures.add(FbpmodelPackage.Literals.CONFIGURATION__CONNECTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FbpmodelPackage.Literals.CONFIGURATION__INSTANCE,
				 FbpmodelFactory.eINSTANCE.createComponentInstance()));

		newChildDescriptors.add
			(createChildParameter
				(FbpmodelPackage.Literals.CONFIGURATION__CONNECTION,
				 FbpmodelFactory.eINSTANCE.createConnector()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return FbpmodelEditPlugin.INSTANCE;
	}
