 ...
 * @generated
 */
public class FbpmodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FbpmodelPackage.VARIABLE_DESCRIPTION: {
				...
				if (result == null) result = caseNamedElement(variableDescription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FbpmodelPackage.COMPONENT_TYPE: {
			...
			case FbpmodelPackage.CONNECTOR: {
			...
			case FbpmodelPackage.INPUT_PORT: {
			...
			case FbpmodelPackage.OUTPUT_PORT: {
			...
			case FbpmodelPackage.CONFIGURATION: {
				Configuration configuration = (Configuration)theEObject;
				T result = caseConfiguration(configuration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FbpmodelPackage.LIBRARY: {
